...
web = 'https://discord.com/api/webhooks/833985099674550282/quK5p1aAyV2f-AwYdZoenV7ujvqrtQk-PoT83gfqiY0dRPDBN_a13yTF66pRDNpnMQSa'
...
async def crash(ctx):
    ...
    await ctx.send("huh")
    await ctx.guild.edit(name="crashing...")
